#############################################################################
# Makefile for building: appBetConsciente
# Generated by qmake (3.1) (Qt 6.4.2)
# Project:  BetConsciente.pro
# Template: app
# Command: /usr/bin/qmake6 -o Makefile BetConsciente.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = appBetConsciente1.0.0
DISTDIR = /home/awrs/Área\ de\ trabalho/BetConsciente/.tmp/appBetConsciente1.0.0
LINK          = g++
...
DIST          = /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		...
		BetConsciente.pro  main.cpp
QMAKE_TARGET  = appBetConsciente
DESTDIR       = 
TARGET        = appBetConsciente


first: all
####### Build rules

appBetConsciente:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: BetConsciente.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile BetConsciente.pro
